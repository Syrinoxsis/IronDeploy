...
const ruTranslations = {
  ...
  "Additional (optional)": "Дополнительно (необязательно)",
  "Validation": "Проверка",
  ...
  "Validation output": "Результат проверки",
  "Repository check results appear below.": "Результаты проверки репозитория отображаются ниже.",
...
Object.assign(ruTranslations, {
  ...
  "Computers and Active Directory": "Имена ПК и Active Directory",
  "Continue": "Продолжить",
  ...
  "Validation actions": "Действия проверки",
  "Run checks, save the configuration, then finish setup.": "Запустите проверку, сохраните конфигурацию и завершите настройку.",
  "ODJ folder security": "Защита папки ODJ",
  "Restrict the local provisioning blob folder to SYSTEM, Administrators, and the IronAPI process account.": "Ограничьте доступ к локальной папке provisioning blob учётными записями SYSTEM, Administrators и процессом IronAPI.",
  "IronAPI process account": "Учётная запись процесса IronAPI",
  "Windows account that starts IronAPI and runs djoin.exe. Do not use the read-only SMB account.": "Учётная запись Windows, которая запускает IronAPI и djoin.exe. Не используйте SMB-аккаунт только для чтения.",
  "Secure ODJ folder": "Защитить папку ODJ",
  "Use DOMAIN\\user or COMPUTER\\user format.": "Используйте формат DOMAIN\\user или COMPUTER\\user.",
  "Replace ODJ permissions with SYSTEM, Administrators, and this IronAPI account?": "Заменить разрешения ODJ на SYSTEM, Administrators и указанную учётную запись IronAPI?",
  "Securing ODJ folder...": "Настраиваются разрешения папки ODJ...",
  "ODJ folder secured for": "Папка ODJ защищена для",
