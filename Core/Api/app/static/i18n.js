(() => {
    ...
    const ru = {
        ...
        "Program files can be up to 5 GiB. Enter one opaque launch argument per line. Spaces and quotes are not supported yet. For MSI installers, enter public properties separately as": "Размер программы — до 5 ГиБ. Вводите по одному непрозрачному аргументу запуска в строке. Пробелы и кавычки пока не поддерживаются. Для MSI задавайте публичные свойства отдельно в виде",
        ...
        "Arguments (one per line), e.g. /S": "Аргументы (по одному в строке), например /S",
        "MSI properties (one NAME=VALUE per line)": "Свойства MSI (по одному NAME=VALUE в строке)",
        "Launch arguments": "Параметры запуска",
        "Launch arguments (one item per row)": "Аргументы запуска (по одному в строке)",
        "Installer configuration": "Конфигурация установщика",
        "Edit configuration": "Изменить конфигурацию",
        "MSI properties": "Свойства MSI",
        "EXE & MSI": "EXE и MSI",
        "MSI only": "Только MSI",
        "One argument per line.": "Один аргумент в строке.",
        "Select an MSI installer to enable this field.": "Выберите установщик MSI, чтобы активировать это поле.",
        "Enter one NAME=VALUE property per line.": "Введите по одному свойству NAME=VALUE в строке.",
        "No arguments or properties": "Без аргументов и свойств",
        "Edit": "Изменить",
        "+ Add argument": "+ Добавить параметр",
        "+ Add MSI property": "+ Добавить свойство MSI",
